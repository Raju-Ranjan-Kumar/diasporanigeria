                            ...
                            <form class="form-horizontal" method="post">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="submit" class="btn btn-primary me-1" value="Upload excel/CSV"/>
                                        <input type="button" class="btn btn-primary me-1" value="Sample CSV" download onclick="location.href='#'" />
                                    </div>
                                </div>
                            </form>
                        </div>
